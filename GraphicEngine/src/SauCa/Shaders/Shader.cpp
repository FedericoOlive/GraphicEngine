...
void Shader::CreateDefaultShaderAnim()
{
    std::cout << "Loading default Shader Anim.\n";
    CreateShaderBySource(ShaderSource::vertexShaderSourceAnim, ShaderSource::fragmentShaderSourceAnim);
}
